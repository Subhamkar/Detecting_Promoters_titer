...
for s in pos_seq_test:
    if s[20:23] in codon_list:
        pos_codon.append(codon_tis_prior[s[20:23]])
for s in neg_seq_test:
    if s[20:23] in codon_list:
        neg_codon.append(codon_tis_prior[s[20:23]])
...
model.save_weights('model_bacillus/my_model1.hdf5')
